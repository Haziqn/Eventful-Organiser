...
public class UserAccount extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.user_acccount, menu);
                    ...
                    databaseReference.child("EVENT_PARTICIPANTS").child(uid).addChildEventListener(new ChildEventListener() {
                        ...
                        public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                            if(dataSnapshot.hasChildren()) {
                                Toast.makeText(UserAccount.this, "You have currently joined events! Please delete all current events.", Toast.LENGTH_LONG).show();
                            } else {
                                ...
                                current_user_db.child("status").setValue("deactivated").addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        ...
                                        Intent i = new Intent(UserAccount.this, StartActivity.class);
